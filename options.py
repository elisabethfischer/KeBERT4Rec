...
from content_tokenizers import CONTENTTOKENIZERS
...
parser.add_argument('--retrieve_test_samples', type= bool,default=False)
...
# content bert args
################
parser.add_argument('--transform_layer', type=str, default=None)
parser.add_argument('--content_encoding_type', type=str, default=None, choices=CONTENTTOKENIZERS.keys())
parser.add_argument('--pretrained_bert_model_name', type=str, default='bert-base-uncased')
